...
export default function TypewriterEffectSmoothDemo() {
  const words = [
    {
      text: "{",
      className: "text-[6rem] text-blue-500 dark:text-blue-500 ",
    },
    {
      text: "Code",
      className: "cedarville-cursive text-[6rem] text-white ",
    },
    {
      text: "}",
      className: "text-[6rem] text-blue-500 dark:text-blue-500 ",
    ...
    {
      text: "with",
      className: "text-[6rem] text-white dark:text-blue-500",
    },
    {
      text: "Kerdos",
      className: "text-[6rem] text-blue-500 dark:text-blue-500",
