...
export default function BackgroundBeamsDemo() {
  return (
    <div
      style={{ background: 'linear-gradient(110deg, #F5F5F7 50%, #10172A 50%)' }}
    ...
    >
      ...
      <img className="h-[70vh] w-[70vh] rounded" src="https://img.freepik.com/free-vector/email-marketing-internet-chatting-24-hours-support_335657-3009.jpg?t=st=1730462012~exp=1730465612~hmac=0cf364511cd4ba279a3e0a03562cbba22b1fb05d9d6c69f7a898159a4e2c6a9d&w=1800" alt="contact-img"/>               
      </div>
      <div className="w-[1px] h-80 border border-gray-700"></div>
      <div className="mx-auto p-4">
        <h3 
        style={{fontWeight: 'bold',textShadow: '2px 2px 4px rgba(0, 0, 0, 1)'}}
